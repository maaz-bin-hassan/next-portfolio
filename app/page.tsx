...
// Lazy load heavy components with ssr: false for 3D content
const Grid = dynamic(
  () => import("@/components/grid").then((m) => ({ default: m.Grid })),
  {
...
const Clients = dynamic(
  ...
  {
    loading: () => <div className="h-32 animate-pulse bg-black-100" />,
  }
);
